...
destination_dir = "user_study_images_new"
...
source_dir = "user_study_images_new"

# Define the destination directory
pairs_dir = "user_study_pairs_new"
...
# further copy the thing with ground truth saved in user_study/dataset/


# Define the source directories
foveated_marked_dir = "user_study/foveated_marked"
original_marked_dir = "user_study/original_marked"
ground_truth_dir = "user_study/dataset"

# Define the destination directory
destination_dir = "user_study_images_new_with_gt"
os.makedirs(destination_dir, exist_ok=True)
os.makedirs(destination_dir+"/original", exist_ok=True)
os.makedirs(destination_dir+"/foveated", exist_ok=True)
os.makedirs(destination_dir+"/dataset", exist_ok=True)
...
for i, image_name in enumerate(image_names, start=1):
    ...
    # change png name to jpg name
    image_name_jpg = image_name.replace(".png", ".jpg")
    ground_truth_path = os.path.join(ground_truth_dir, image_name_jpg)
    ...
    # directly copy the ground truth
    shutil.copy(ground_truth_path, os.path.join(destination_dir, f"dataset/{i}.jpg"))
...
# Define the source directory
source_dir = "user_study_images_new_with_gt"

# Define the destination directory
pairs_dir = "user_study_pairs_new_with_gt"
os.makedirs(pairs_dir, exist_ok=True)
...
for i in range(1, 21):
    ...
    foveated_image = os.path.join(source_dir, f"foveated/{i}.png")
    original_image = os.path.join(source_dir, f"original/{i}.png")
    gt_image = os.path.join(source_dir, f"dataset/{i}.jpg")
    ...
    shutil.copy(a_image, os.path.join(pair_dir, "a.png"))
    shutil.copy(b_image, os.path.join(pair_dir, "b.png"))
    shutil.copy(gt_image, os.path.join(pair_dir, "gt.jpg"))
