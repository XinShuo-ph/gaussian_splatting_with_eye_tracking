...
errors = np.load('error_stat_resnet/prediction_errors.npy')  # Shape: (N, 6, 2)
...
for layer_index in range(4):
    ...
    plt.savefig('error_stat_resnet/joint_distribution_layer%d.pdf'%(layer_index+1), bbox_inches='tight')
