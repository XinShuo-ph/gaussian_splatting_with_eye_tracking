...
errors = np.load('error_stat_deepvog6/prediction_errors.npy')  # Shape: (N, 6, 2)
...
for layer_index in range(6):
    ...
    plt.savefig('error_stat_deepvog6/joint_distribution_layer%d.pdf'%(layer_index+1), bbox_inches='tight')
    plt.savefig('error_stat_deepvog6/joint_distribution_layer%d.png'%(layer_index+1), bbox_inches='tight')
    plt.show()
...
# # plt.grid()
# plt.savefig('error_stat_deepvog6/avg_std_layers.pdf', bbox_inches='tight')
# plt.savefig('error_stat_deepvog6/avg_std_layers.png', bbox_inches='tight')
# plt.show()