...
def parse_args():
    ...
    parser.add_argument(
        "--val_folder",
        type=str,
        default="/home/ubuntu/openeds/validation/",
        help="training folder",
    )
    parser.add_argument(
        "--train_folder",
        type=str,
        default="/home/ubuntu/openeds/train/",
        help="training folder",
    )
    parser.add_argument(
        "--val_info",
        type=str,
        default="/home/ubuntu/openeds/val.csv",
        help="training folder",
    )
    parser.add_argument(
        "--train_info",
        type=str,
        default="/home/ubuntu/openeds/train.csv",
        help="training folder",
    )
    parser.add_argument(
        "--info_file",
...
def main():
    ...
    # dataset = EdsDataset(image_folder=args.image_folder, info_file=args.info_file)
    # all_folders = [args.train_folder, args.val_folder]
    # train_folders, val_folders = split_folders(all_folders, train_ratio=0.8)
    ...
    # final_val_dataset = AllEdsDataset(image_folder=args.val_folder)
    # final_val_dataset.data = train_dataset.data + val_dataset.data

    # new_train_data, new_val_data = train_test_split(
    #     final_train_data, test_size=0.1, random_state=42
    # )
    # final_train_dataset.data = new_train_data
    # final_val_dataset.data = new_val_data
